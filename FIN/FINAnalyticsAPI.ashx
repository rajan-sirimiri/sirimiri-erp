<%@ WebHandler Language="C#" Class="FINApp.FINAnalyticsAPI" %>
    ...
    public class FINAnalyticsAPI : IHttpHandler, IRequiresSessionState
    {
        ...
        private string GetProductMix(string state, string city)
        {
            ...
            if (!string.IsNullOrEmpty(city))
                ...
                data = FINDatabaseHelper.GetMonthlyProductSalesByState("");
        ...
        {
            // Distributors who ordered before but not in last 45 days
