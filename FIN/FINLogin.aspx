...
<style>
:root { --accent:#8e44ad; --accent-dark:#6c3483; --surface:#fff; --bg:#f5f5f5; --border:#e0e0e0; --text:#1a1a1a; --muted:#666; --radius:12px; }
...
.card-header img { height:72px; width:auto; object-fit:contain; filter:drop-shadow(0 2px 8px rgba(142,68,173,.2)); }
...
.module-badge  { background:rgba(142,68,173,.08); border:1px solid rgba(142,68,173,.2);
...
.accent-bar { height:3px; background:linear-gradient(90deg,var(--accent),#a569bd,var(--accent)); }
...
.field input:focus { outline:none; border-color:var(--accent); background:#fff; box-shadow:0 0 0 3px rgba(142,68,173,.1); }
  ...
  <div class="card">
    <div class="card-header">
      ...
      <div class="module-badge">
        ...
        <div class="module-badge-name">Finance</div>
      </div>
    </div>
    ...
    <div class="card-body">
      ...
      <div class="card-subtitle">Finance &amp; Tally Integration Module</div>
