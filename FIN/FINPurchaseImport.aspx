<%@ Page Language="C#" AutoEventWireup="true" Inherits="FINApp.FINPurchaseImport" EnableEventValidation="false" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
<meta charset="utf-8"/>
<meta name="viewport" content="width=device-width,initial-scale=1"/>
<title>Sirimiri FIN — Purchase Import</title>
...
<nav>
    ...
    <span class="nav-title">FIN — Purchase Invoice Import</span>
    <div class="nav-right">
...
<div class="card">
    <div class="card-title">&#x1F6D2; Upload Tally Purchase Report</div>
    <div class="card-sub">Upload Purchase_Report.xlsx. Preview and validate before importing.</div>
...
<div class="card">
    ...
    <div class="summary-bar">
        ...
        <div class="summary-stat"><div class="val" style="color:var(--blue);"><asp:Label ID="lblPreviewSkipped" runat="server" Text="0"/></div><div class="lbl">Already Imported</div></div>
    ...
    <asp:Panel ID="pnlUnmapped" runat="server" Visible="false">
        <div style="background:#fdf3f2;border:1px solid #f5c6cb;border-radius:10px;padding:14px;margin-bottom:14px;">
            <div style="font-size:12px;font-weight:700;color:var(--red);margin-bottom:8px;">&#x26A0; Unmapped Items — map them in Purchase Mapping for full traceability.</div>
    ...
    <div style="display:flex;gap:12px;align-items:center;">
        <asp:Button ID="btnImport" runat="server" Text="&#x1F4E5; Import Purchase Data" CssClass="btn btn-teal" OnClick="btnImport_Click"
            OnClientClick="return erpConfirmLink(this, 'Import all new purchase invoices? Already imported ones will be skipped.', {title:'Import Purchases', okText:'Yes, Import', btnClass:'success'})"/>
        <span style="font-size:11px;color:var(--text-dim);">Already imported invoices will be skipped.</span>
    </div>
</div>
</asp:Panel>
