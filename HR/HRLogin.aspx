<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRLogin.aspx.cs" Inherits="HRModule.HRLogin" %>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8"/>
...
<title>Login &mdash; Human Resources</title>
<style>
:root { --accent:#0d9488; --accent-dark:#0f766e; --accent-soft:#2dd4bf; --surface:#fff; --bg:#f5f5f5; --border:#e0e0e0; --text:#1a1a1a; --muted:#666; --radius:12px; }
...
.card-header img { height:72px; width:auto; object-fit:contain; filter:drop-shadow(0 2px 8px rgba(13,148,136,.2)); }
...
.module-badge  { background:rgba(13,148,136,.08); border:1px solid rgba(13,148,136,.2);
...
.accent-bar { height:3px; background:linear-gradient(90deg,var(--accent),var(--accent-soft),var(--accent)); }
...
.field input:focus { outline:none; border-color:var(--accent); background:#fff; box-shadow:0 0 0 3px rgba(13,148,136,.1); }
  ...
  <div class="card">
    <div class="card-header">
      ...
      <div class="module-badge">
        ...
        <div class="module-badge-name">HR</div>
      </div>
    </div>
    ...
    <div class="card-body">
      ...
      <div class="card-subtitle">Human Resources Module</div>
