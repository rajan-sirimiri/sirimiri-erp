<%@ Page Language="C#" AutoEventWireup="true" Inherits="PKApp.PKChangePassword" %>
<!DOCTYPE html><html lang="en"><head runat="server">
<meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/>
<title>Change Password &mdash; PK</title>
...
<div class="pwd-card">
    ...
    <div class="pwd-sub">Packing & Shipments &mdash; Your password must be changed before continuing.</div>
