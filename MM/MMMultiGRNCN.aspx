<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MMMultiGRNCN.aspx.cs" Inherits="MMApp.MMMultiGRNCN" EnableEventValidation="false" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
<meta charset="utf-8"/>
...
<nav>
    ...
    <div class="nav-right">
        ...
        <a href="MMConsumableInward.aspx" class="nav-link">Single GRN</a>
    </div>
</nav>
...
<div class="page-header">
    ...
    <div>
        <div class="page-title">Multi-Item <span>GRN</span> — Consumables</div>
        <div class="page-sub">Record multiple consumables from a single invoice</div>
    </div>
</div>
    ...
    <div class="card">
        ...
        <div style="overflow-x:auto;">
            <table class="items-table" id="tblItems">
                <thead><tr>
                    <th class="col-rm">Consumable Item *</th>
