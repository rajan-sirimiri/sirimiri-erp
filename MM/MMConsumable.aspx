<%@ Page Language="C#" AutoEventWireup="true" Inherits="MMApp.MMConsumable" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Consumables &mdash; MM</title>
    <link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=DM+Sans:wght@300;400;500;600&display=swap" rel="stylesheet" />
    <link rel="stylesheet" href="/StockApp/erp-tablet.css"/>
    <style>
        :root { --bg:#f5f5f5; --surface:#fff; --border:#e0e0e0; --accent:#cc1e1e; --primary:#e07b00; --text:#1a1a1a; --text-muted:#666; --text-dim:#999; --radius:12px; }
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .btn-primary:hover { background:#b56200; }
        ...
        .badge-active   { display:inline-block; padding:2px 8px; border-radius:20px; font-size:10px; font-weight:700; background:rgba(224,123,0,0.12); color:var(--primary); }
...
<form id="form1" runat="server">
    <nav>
        ...
        <span class="nav-sep">&rsaquo;</span>
        <span class="nav-item active">Consumables</span>
        <div class="nav-right">
    ...
    <div class="page-header">
        <div class="page-title">Consumables <span>Registration</span></div>
        <div class="page-sub">Manage consumable items &mdash; add, edit and activate/deactivate</div>
    </div>
    ...
    <div class="content">
        <div>
            ...
            <div class="card">
                <div class="card-title"><asp:Label ID="lblFormTitle" runat="server" Text="New Consumable" /></div>
                <asp:HiddenField ID="hfConsumableID" runat="server" Value="0" />
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtName" runat="server" MaxLength="200" placeholder="e.g. Lubricant Oil" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group full">
                        ...
                        <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" MaxLength="500" placeholder="Optional notes about this consumable..." />
                    </div>
                </div>
                <div class="btn-row">
        ...
        <div class="list-card">
            <div class="list-header">
                <span class="list-title">Consumables</span>
            ...
            <div style="overflow-x:auto;max-height:600px;overflow-y:auto;">
                <asp:Repeater ID="rptItems" runat="server" OnItemCommand="rptItems_ItemCommand">
                    ...
                    <ItemTemplate>
                        <tr>
                            <td style="font-weight:600;font-size:12px;color:var(--text-muted);"><%# Eval("ConsumableCode") %></td>
                            <td>
                                <div style="font-weight:500;"><%# Eval("ConsumableName") %></div>
                            ...
                            <td><asp:LinkButton runat="server" CommandName="Edit" CommandArgument='<%# Eval("ConsumableID") %>' CssClass="act-link" CausesValidation="false">Edit</asp:LinkButton></td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate></tbody></table></FooterTemplate>
                </asp:Repeater>
                <asp:Panel ID="pnlEmpty" runat="server" Visible="false">
                    <div class="empty-state">No consumables found. Add your first item.</div>
                </asp:Panel>
            </div>
        </div>
    </div>
