<%@ Page Language="C#" AutoEventWireup="true" Inherits="MMApp.MMPackingMaterial" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Packing Materials &mdash; MM</title>
    <link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=DM+Sans:wght@300;400;500;600&display=swap" rel="stylesheet" />
    <link rel="stylesheet" href="/StockApp/erp-tablet.css"/>
    <style>
        :root { --bg:#f5f5f5; --surface:#ffffff; --border:#e0e0e0; --accent:#cc1e1e; --blue:#1e78cc; --text:#1a1a1a; --text-muted:#666; --text-dim:#999; --radius:12px; }
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card-title { font-family: 'Bebas Neue', sans-serif; font-size: 18px; letter-spacing: .07em; color: var(--text); margin-bottom: 24px; padding-bottom: 14px; border-bottom: 2px solid var(--blue); }
        ...
        .btn-primary:hover { background: #155f9e; }
        ...
        .alert-success { background: rgba(30,120,204,0.08); color: var(--blue); border: 1px solid rgba(30,120,204,0.25); }
        ...
        .pm-table th { padding: 10px 14px; text-align: left; font-size: 10px; font-weight: 700; letter-spacing: .1em; text-transform: uppercase; color: var(--text-dim); background: #fafafa; border-bottom: 1px solid var(--border); }
        .pm-table td { padding: 11px 14px; font-size: 13px; border-bottom: 1px solid #f0f0f0; vertical-align: middle; }
        .pm-table tr:last-child td { border-bottom: none; }
        .pm-table tr:hover td { background: #fafafa; }
        .badge-active { display: inline-block; padding: 2px 8px; border-radius: 20px; font-size: 10px; font-weight: 700; background: rgba(30,120,204,0.12); color: var(--blue); }
        ...
        .act-link { font-size: 12px; color: var(--blue); cursor: pointer; font-weight: 600; }
...
<form id="form1" runat="server">
    ...
    <div class="page-header">
        <div class="page-title">Packing <span>Materials</span></div>
        <div class="page-sub">Manage packing material master &mdash; add, edit and activate/deactivate</div>
    </div>
    ...
    <div class="content">
        <div>
            ...
            <div class="card">
                <div class="card-title"><asp:Label ID="lblFormTitle" runat="server" Text="New Packing Material" /></div>
                <asp:HiddenField ID="hfPMID" runat="server" Value="0" />
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <span class="field-hint">How is this material consumed when issued to Floor?</span>
                    </div>
                    <div class="form-group">
                        <label>HSN Code</label>
                        <asp:TextBox ID="txtHSN" runat="server" MaxLength="20" placeholder="e.g. 3923" />
        ...
        <div class="list-card">
            <div class="list-header">
                <span class="list-title">Packing Materials</span>
                <asp:Label ID="lblCount" runat="server" CssClass="list-count" Text="0 records" />
            </div>
            <div class="list-search">
                <input type="text" placeholder="Search..." onkeyup="filterTable(this.value,'pmTable')" />
            </div>
            <div style="overflow-x:auto; max-height:600px; overflow-y:auto;">
                <asp:Repeater ID="rptMaterials" runat="server" OnItemCommand="rptMaterials_ItemCommand">
                    ...
                    <ItemTemplate>
                        <tr>
                            <td style="font-weight:600;font-size:12px;color:var(--text-muted);"><%# Eval("PMCode") %></td>
                            <td>
                ...
                <asp:Panel ID="pnlEmpty" runat="server" Visible="false">
                    <div class="empty-state">No packing materials found. Add your first material.</div>
                </asp:Panel>
            </div>
        </div>
    </div>
