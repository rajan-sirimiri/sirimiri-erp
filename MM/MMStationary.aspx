<%@ Page Language="C#" AutoEventWireup="true" Inherits="MMApp.MMStationary" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Stationaries &amp; Other Items &mdash; MM</title>
    <link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=DM+Sans:wght@300;400;500;600&display=swap" rel="stylesheet" />
    <link rel="stylesheet" href="/StockApp/erp-tablet.css"/>
    <style>
        :root { --bg:#f5f5f5; --surface:#fff; --border:#e0e0e0; --accent:#cc1e1e; --primary:#4a7fa5; --text:#1a1a1a; --text-muted:#666; --text-dim:#999; --radius:12px; }
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .card-title { font-family:'Bebas Neue',sans-serif; font-size:18px; letter-spacing:.07em; color:var(--text); margin-bottom:24px; padding-bottom:14px; border-bottom:2px solid var(--primary); }
        ...
        .btn-primary:hover { background:#376590; }
        ...
        .item-table th { padding:10px 14px; text-align:left; font-size:10px; font-weight:700; letter-spacing:.1em; text-transform:uppercase; color:var(--text-dim); background:#fafafa; border-bottom:1px solid var(--border); }
        .item-table td { padding:11px 14px; font-size:13px; border-bottom:1px solid #f0f0f0; vertical-align:middle; }
        .item-table tr:last-child td { border-bottom:none; }
        .item-table tr:hover td { background:#fafafa; }
        .badge-active   { display:inline-block; padding:2px 8px; border-radius:20px; font-size:10px; font-weight:700; background:rgba(74,127,165,0.12); color:var(--primary); }
        ...
        .act-link { font-size:12px; color:var(--primary); cursor:pointer; font-weight:600; }
...
<form id="form1" runat="server">
    <nav>
        ...
        <span class="nav-sep">&rsaquo;</span>
        <span class="nav-item active">Stationaries &amp; Other Items</span>
        <div class="nav-right">
    ...
    <div class="page-header">
        <div class="page-title">Stationaries <span>&amp; Other Items</span></div>
        <div class="page-sub">Manage stationery and miscellaneous items &mdash; add, edit and activate/deactivate</div>
    </div>
    ...
    <div class="content">
        <div>
            ...
            <div class="card">
                <div class="card-title"><asp:Label ID="lblFormTitle" runat="server" Text="New Item" /></div>
                <asp:HiddenField ID="hfStationaryID" runat="server" Value="0" />
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtName" runat="server" MaxLength="200" placeholder="e.g. A4 Paper Ream" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <span class="field-hint">How is this stationery consumed when issued to Floor?</span>
                    </div>
                    <div class="form-group">
                        <label>HSN Code</label>
                        <asp:TextBox ID="txtHSN" runat="server" MaxLength="20" placeholder="e.g. 4820" />
                    ...
                    <div class="form-group full">
                        ...
                        <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" MaxLength="500" placeholder="Optional notes about this item..." />
                    </div>
                </div>
                <div class="btn-row">
        ...
        <div class="list-card">
            <div class="list-header">
                <span class="list-title">Stationaries &amp; Other Items</span>
                <asp:Label ID="lblCount" runat="server" CssClass="list-count" Text="0 records" />
            </div>
            <div class="list-search">
                <input type="text" placeholder="Search by code, name..." onkeyup="filterTable(this.value,'itemTable')" />
            </div>
            <div style="overflow-x:auto;max-height:600px;overflow-y:auto;">
                <asp:Repeater ID="rptItems" runat="server" OnItemCommand="rptItems_ItemCommand">
                    ...
                    <ItemTemplate>
                        <tr>
                            <td style="font-weight:600;font-size:12px;color:var(--text-muted);"><%# Eval("StationaryCode") %></td>
                            <td>
                                <div style="font-weight:500;"><%# Eval("StationaryName") %></div>
                            ...
                            <td><asp:LinkButton runat="server" CommandName="Edit" CommandArgument='<%# Eval("StationaryID") %>' CssClass="act-link" CausesValidation="false">Edit</asp:LinkButton></td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate></tbody></table></FooterTemplate>
                </asp:Repeater>
                <asp:Panel ID="pnlEmpty" runat="server" Visible="false">
                    <div class="empty-state">No items found. Add your first stationery or miscellaneous item.</div>
                </asp:Panel>
            </div>
        </div>
    </div>
