<%@ Page Language="C#" AutoEventWireup="true" Inherits="MMApp.MMLogin" %>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8"/>
...
<title>Login &mdash; Materials Management</title>
<style>
:root { --accent:#cc1e1e; --surface:#fff; --bg:#f5f5f5; --border:#e0e0e0; --text:#1a1a1a; --muted:#666; --radius:12px; }
...
.card-header img { height:72px; width:auto; object-fit:contain; filter:drop-shadow(0 2px 8px rgba(204,30,30,.2)); }
...
.module-badge  { background:rgba(204,30,30,.08); border:1px solid rgba(204,30,30,.2);
...
/* Red bar */
.accent-bar { height:3px; background:linear-gradient(90deg,var(--accent),#e63030,var(--accent)); }
...
.field input:focus { outline:none; border-color:var(--accent); background:#fff; box-shadow:0 0 0 3px rgba(204,30,30,.1); }
...
.btn-login:hover { background:#a81818; }
  ...
  <div class="card">
    <div class="card-header">
      ...
      <div class="module-badge">
        ...
        <div class="module-badge-name">Materials<br/>Mgmt</div>
      </div>
    </div>
    ...
    <div class="card-body">
      ...
      <div class="card-subtitle">Materials Management Module</div>
