...
namespace MMApp
{
    public partial class MMStationaryInward : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!MMDatabaseHelper.RoleHasModuleAccess(__role, "MM", "MM_ST_GRN"))
        ...
        {
            DataTable itemDt = MMDatabaseHelper.GetActiveStationaries();
            ddlItem.DataSource     = itemDt;
            ddlItem.DataTextField  = "StationaryName";
            ddlItem.DataValueField = "StationaryID";
            ddlItem.DataBind();
        ...
        private void LoadRecoverables(int supplierId)
        {
            ...
            DataTable dt = MMDatabaseHelper.GetSupplierStationaryRecoverables(supplierId);
            if (dt.Rows.Count > 0)
            {
        ...
        private void LoadGRNList()
        {
            ...
            DataTable dt = MMDatabaseHelper.GetStationaryInwardList(from, to);
            if (dt.Rows.Count > 0)
            {
        ...
        {
            if (ddlItem.SelectedValue == "0")             { ShowAlert("Please select a Stationary/Other Item.", false); return false; }
        ...
        private void SaveGRN(string status)
        {
            try
            {
                ...
                MMDatabaseHelper.AddStationaryInward(
                    ...
                    txtInvoiceNo.Text.Trim(), supId, itemId,
