<%@ Page Language="C#" AutoEventWireup="true" Inherits="MMApp.MMSTStockReport" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Stationary Stock Report &mdash; MM</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .st-code { font-size:11px; color:var(--text-dim); margin-top:1px; }
...
<nav>
    ...
    <a href="MMSTStockReport.aspx" class="nav-item active">Stock Report</a>
    <div class="nav-right">
...
<div class="page-header">
    <div>
        <div class="page-title">Stationary <span>Stock Report</span></div>
...
<div class="main">
    <div class="card">
        <div class="card-header">
            <span class="card-title">&#128230; Stationarys — Stock Position</span>
            <span class="report-date">As of <asp:Label ID="lblReportDate" runat="server"/></span>
        </div>

        <div class="print-header">
            Sirimiri Nutrition Food Products &nbsp;|&nbsp; Stationary Stock Report &nbsp;|&nbsp;
                ...
                <asp:Repeater ID="rptStock" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><span class="st-code"><%# Eval("StationaryCode") %></span></td>
                            <td><span class="st-name"><%# Eval("StationaryName") %></span></td>
                            <td><%# Eval("UOM") %></td>
                            <td class="num">
