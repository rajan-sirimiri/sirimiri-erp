<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MMMultiGRNPM.aspx.cs" Inherits="MMApp.MMMultiGRNPM" EnableEventValidation="false" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
<meta charset="utf-8"/>
...
<nav>
    ...
    <div class="nav-right">
        ...
        <a href="MMPackingInward.aspx" class="nav-link">Single GRN</a>
    </div>
</nav>
...
<div class="page-header">
    ...
    <div>
        <div class="page-title">Multi-Item <span>GRN</span> — Packing Materials</div>
        <div class="page-sub">Record multiple packing materials from a single invoice</div>
    </div>
</div>
    ...
    <div class="card">
        ...
        <div style="overflow-x:auto;">
            <table class="items-table" id="tblItems">
                <thead><tr>
                    <th class="col-rm">Packing Material *</th>
...
<script>
    ...
    var rmData = <%= ItemDataJson %>;

    // ── RM options for dropdown ──
    var rmOptions = <%= ItemOptionsJson %>;
    ...
    function loadRecoverablesAjax(supId) {
        ...
        fetch('MMRecoverablesAPI.ashx?supId=' + supId + '&type=PM')
