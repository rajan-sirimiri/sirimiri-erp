<%@ Page Language="C#" AutoEventWireup="true" Inherits="MMApp.MMPMStockReport" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Packing Material Stock Report &mdash; MM</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .pm-code { font-size:11px; color:var(--text-dim); margin-top:1px; }
...
<nav>
    ...
    <a href="MMPackingInward.aspx" class="nav-item">PM GRN</a>
    <a href="MMRMStockReport.aspx" class="nav-item">RM Stock</a>
    <a href="MMPMStockReport.aspx" class="nav-item active">PM Stock</a>
    <div class="nav-right">
...
<div class="page-header">
    <div>
        ...
        <div class="page-sub">Current stock position — Opening Stock + GRN Received &minus; Packing Consumed</div>
    </div>
...
<div class="main">
    <div class="card">
        ...
        <div class="print-header">
            Sirimiri Nutrition Food Products &nbsp;|&nbsp; Packing Material Stock Report &nbsp;|&nbsp;
...
function printReport() {
    ...
    document.title = 'PM Stock Report ' + dd + '-' + mm + '-' + yy + ' ' + hh + '' + min;
    window.print();
