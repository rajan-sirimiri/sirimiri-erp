            ...
            <div class="card">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group" style="background:rgba(74,127,165,0.06);border:1.5px solid rgba(74,127,165,0.3);border-radius:10px;padding:10px 12px;">
                        ...
                        <div style="display:flex;gap:6px;align-items:center;">
                            <asp:TextBox ID="txtQtyUOM" runat="server" placeholder="0" onchange="calcAll()" onkeyup="calcAll()" style="flex:1;border-color:rgba(74,127,165,0.4);background:#f0f6ff;" />
...
<script>
    ...
    function setInvoiceMode(mode) {
        ...
        if (mode === 'manual') {
            ...
            // 'normal' — strip any MN- or legacy prefix, re-enable all fields
