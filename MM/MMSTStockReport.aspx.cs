...
namespace MMApp
{
    public partial class MMSTStockReport : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!MMDatabaseHelper.RoleHasModuleAccess(__role, "MM", "MM_ST_REPORT"))
        ...
        private void BindReport()
        {
            ...
            var dt = MMDatabaseHelper.GetSTStockReport();
