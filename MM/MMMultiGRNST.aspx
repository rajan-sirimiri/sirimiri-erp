...
<nav>
    ...
    <div class="nav-right">
        ...
        <a href="MMStationaryInward.aspx" class="nav-link">Single GRN</a>
    </div>
</nav>
...
<div class="page-header">
    ...
    <div>
        <div class="page-title">Multi-Item <span>GRN</span> — Stationary / Supplies</div>
        <div class="page-sub">Record multiple stationary items from a single invoice</div>
    </div>
</div>
...
<script>
    ...
    function loadRecoverablesAjax(supId) {
        ...
        fetch('MMRecoverablesAPI.ashx?supId=' + supId + '&type=ST')
