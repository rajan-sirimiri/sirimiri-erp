<%@ Page Language="C#" AutoEventWireup="true" Inherits="UAApp.UAChangePassword" %>
<!DOCTYPE html><html lang="en"><head runat="server">
<meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/>
<title>Change Password &mdash; UA</title>
...
<div class="pwd-card">
    ...
    <div class="pwd-sub">User Administration &mdash; Your password must be changed before continuing.</div>
