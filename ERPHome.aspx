...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .header-logo img { height: 52px; width: auto; object-fit: contain; filter: drop-shadow(0 2px 12px rgba(204,30,30,0.35)); }
        ...
        .header-brand {
            font-family: 'Bebas Neue', sans-serif;
            font-size: 26px; letter-spacing: .10em; color: var(--text); line-height: 1;
        }
        ...
        .section-label { font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: .22em; color: var(--text-dim); text-align: center; margin-bottom: 10px; }
        .section-title { font-family: 'Bebas Neue', sans-serif; font-size: 36px; letter-spacing: .08em; text-align: center; color: var(--text); margin-bottom: 6px; }
        .section-title span { color: var(--accent); }
        .section-sub { text-align: center; font-size: 14px; color: var(--text-muted); font-style: italic; font-weight: 300; margin-bottom: 56px; }
        ...
        .module-card::before { content: ''; position: absolute; top: 0; right: 0; width: 120px; height: 120px; border-radius: 0 var(--radius) 0 120px; opacity: 0; transition: opacity .3s; }
        .module-card:hover { border-color: var(--accent); transform: translateY(-4px); box-shadow: 0 12px 32px rgba(0,0,0,0.12), 0 0 0 1px var(--accent); }
        .module-card:hover::before { opacity: 1; }
        .module-card::after { content: ''; position: absolute; bottom: 0; left: 0; right: 0; height: 2px; transform: scaleX(0); transform-origin: left; transition: transform .3s ease; }
        .module-card:hover::after { transform: scaleX(1); }
        .module-icon-wrap { width: 58px; height: 58px; border-radius: 14px; display: flex; align-items: center; justify-content: center; font-size: 26px; position: relative; z-index: 1; transition: transform .3s; flex-shrink: 0; }
        .module-card:hover .module-icon-wrap { transform: scale(1.08); }
        .module-info { position: relative; z-index: 1; }
        .module-name { font-family: 'Bebas Neue', sans-serif; font-size: 22px; letter-spacing: .07em; color: var(--text); line-height: 1.1; margin-bottom: 6px; }
        .module-desc { font-size: 12px; color: var(--text-muted); font-weight: 400; line-height: 1.5; }
        .module-arrow { position: absolute; bottom: 20px; right: 22px; font-size: 18px; color: #cccccc; transition: color .3s, transform .3s; }
        .module-card:hover .module-arrow { color: var(--accent); transform: translate(3px, -3px); }
        ...
        .module-status { position: absolute; top: 16px; right: 16px; font-size: 10px; font-weight: 700; letter-spacing: .08em; text-transform: uppercase; padding: 3px 10px; border-radius: 20px; }
        .status-live { background: rgba(26,158,106,0.15); color: #2dcb82; }
        .status-soon { background: rgba(201,168,76,0.12); color: var(--gold); }
        footer { position: relative; z-index: 1; text-align: center; padding: 24px; border-top: 1px solid var(--border); font-size: 12px; color: var(--text-muted); letter-spacing: .06em; }
        @media (max-width: 768px) { .module-grid { grid-template-columns: repeat(2, 1fr); } main { padding: 40px 20px 60px; } header { padding: 0 20px; } }
...
<body>
    ...
    <header>
        <div class="header-logo">
            ...
            <div id="logoFallback" class="header-logo-fallback">SN</div>
        </div>
        ...
        <div class="header-right">
            <a href="StockApp/Login.aspx" class="btn-login">&#x2192; Sign In</a>
        </div>
    </header>
    ...
    <main>
        ...
        <div class="module-grid">
            ...
            <a href="StockApp/StockEntry.aspx" class="module-card mod-sales">
                <span class="module-status status-live">Live</span>
                <div class="module-icon-wrap">&#x1F4C8;</div>
                <div class="module-info">
            ...
            <a href="StockApp/Reports.aspx" class="module-card mod-bi">
                <span class="module-status status-live">Live</span>
                <div class="module-icon-wrap">&#x1F9E0;</div>
                <div class="module-info">
    ...
    <footer>
        &copy; 2026 Sirimiri Nutrition &mdash; ERP v2.0
    </footer>
